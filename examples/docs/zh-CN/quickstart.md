...
```javascript
import Vue from 'vue';
import ElementUI from 'lhb-ceshi-ui';
import 'lhb-ceshi-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'lhb-ceshi-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import Element from 'lhb-ceshi-ui';
...
```js
import Vue from 'vue';
import { Button } from 'lhb-ceshi-ui';
